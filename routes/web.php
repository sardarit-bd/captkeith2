...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:owner')->group(function () {
        ...
        Route::post('charterers/{id}/cancel-completion', [\App\Http\Controllers\CharterController::class, 'cancelCompletionRequest'])->name('charterers.cancel-completion');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get('/admin/deckhands/{deckhand}/profile', [\App\Http\Controllers\DeckhandController::class, 'showProfile'])
            ...
            ->middleware('can:admin');
        Route::patch('admin/withdrawals/{id}/status', [\App\Http\Controllers\Admin\WithdrawalController::class, 'updateStatus'])->name('admin.withdrawals.update');
        ...
        Route::patch('admin/withdrawals/{id}/complete', [\App\Http\Controllers\Admin\WithdrawalController::class, 'complete'])->name('admin.withdrawals.complete');
    });

    // ==========================================
    // CREW ROUTES (Owner, Captain, Deckhand)
    // ==========================================
    ...
    Route::middleware('role:charterer')->group(function () {
        ...
        Route::post('my-booking/{id}/confirm-completion', [\App\Http\Controllers\MyBookingController::class, 'confirmCompletion'])->name('my-booking.confirm-completion');
