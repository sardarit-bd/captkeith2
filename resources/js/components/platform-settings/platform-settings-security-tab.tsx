...
export function PlatformSettingsSecurityTab() {
    return (
        <div className="space-y-6">
            <div className="border-b border-[#e6ebf1] pb-4">
                ...
                <p className="mt-1 text-sm text-slate-500">
                    Configure admin authentication rules and compliance data
                    retention.
                </p>
            </div>
                ...
                <div className="space-y-6">
                    <div className="flex flex-col justify-between gap-4 border-b border-slate-100 pb-6 md:flex-row md:items-center">
                        <div>
                            ...
                            <p className="mt-1 text-xs text-slate-500">
                                Enforce authenticator-based 2FA for all super
                                admin accounts.
                            </p>
                        </div>
                        <ToggleField checked />
                    ...
                    <label className="block space-y-1.5 space-x-2">
                        ...
                        <p className="text-xs text-slate-500">
                            Automatically log out inactive admins to protect
                            sensitive user data.
                        </p>
                    </label>
                </div>
            ...
            <SettingsSectionCard title="Data & Compliance Retention">
                <label className="block space-y-1.5 space-x-2">
                    ...
                    <select className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm transition-all focus:border-[#35ADD5] focus:outline-none focus:ring-2 focus:ring-[#35ADD5]/20 md:w-1/2">
                        ...
                        <option>7 Years (USCG Audit Standard)</option>
                        <option>Indefinitely</option>
                    </select>
                    <p className="text-xs text-slate-500">
                        Timeframe for retaining demise charter agreements and
                        VQUIP policies after charter completion.
                    </p>
                </label>
            </SettingsSectionCard>
        </div>
