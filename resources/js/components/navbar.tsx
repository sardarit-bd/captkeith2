...
export function Navbar({
    ...
    return (
        <nav className="sticky top-0 z-50 flex w-full items-center justify-between bg-white px-4 py-4 shadow-sm md:px-10">
            <img src="/images/icon.png" alt="CaptMatch" className="h-auto w-32 md:w-40" />
