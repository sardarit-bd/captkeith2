...
export function AdminVerificationTable({
    ...
    const handleApprove = (id: string, profileType: 'captain' | 'deckhand') => {
        router.patch(
            `/admin/${profileType}s/${id}/approve`,
            {},
            {
                preserveScroll: true,
            },
            ...
            <div className="flex items-center justify-between border-b px-6 py-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Captains and deckhands awaiting license review
                    </p>
                </div>
                <Button
                    variant="link"
                            ...
                            <TableCell className="text-right">
                                <div className="flex justify-end gap-2">
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            handleReject(item.id, item.type)
                                        }
                                    >
                                        Reject
                                    </Button>
