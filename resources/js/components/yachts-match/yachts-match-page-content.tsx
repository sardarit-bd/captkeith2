...
export function YachtsMatchPageContent() {
    ...
    const isVerified =
        page.props.auth?.user?.captain_profile?.is_verified ||
        page.props.auth?.user?.deckhand_profile?.is_verified ||
        null;
                ...
                <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-sm">
                    {isVerified === 'pending' && (
                        <>
                            ...
                            <p className="text-gray-600">
                                Your request has been sent and is currently
                                being reviewed by an admin. We&apos;ll notify
                    ...
                    {isVerified === 'rejected' && (
                        <>
                            ...
                            <p className="mb-6 text-gray-600">
                                The admin rejected your request. Please update
                                your profile and request again.
                            </p>
                    ...
                    {isVerified === null && (
                        <>
                            ...
                            <p className="mb-6 text-gray-600">
                                Your profile is not yet verified by an admin.
                                You must be verified to view yacht matches.
                            </p>
                            <div className="flex flex-col gap-3">
                                <Button
                                    onClick={handleRequestApproval}
