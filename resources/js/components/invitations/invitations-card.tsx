...
const statusStyles: Record<OwnerInvitationRecord['status'], string> = {
    pending: 'bg-[#fef9c3] text-[#854d0e]',
    accepted: 'bg-[#dcfce7] text-[#166534]',
    declined: 'bg-[#fee2e2] text-[#991b1b]',
};

const statusLabels: Record<OwnerInvitationRecord['status'], string> = {
    pending: 'Pending',
    accepted: 'Accepted',
    declined: 'Declined',
};
...
export function InvitationCard({
    ...
    function handleRespond(status: 'accepted' | 'declined') {
        ...
        router.patch(
            `/invitations/${invitation.id}/respond`,
            { status },
            {
                preserveScroll: true,
