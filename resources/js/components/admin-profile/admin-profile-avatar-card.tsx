...
export function AdminProfileAvatarCard() {
    return (
        <section className="flex flex-col items-center rounded-2xl border border-[#e6ebf1] bg-white p-6 shadow-sm sm:flex-row sm:space-x-8 md:p-8">
            <button type="button" className="group relative mb-4 sm:mb-0">
                <span className="relative flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-4 border-slate-50 bg-[#11395d] text-3xl font-semibold text-white shadow-sm sm:h-28 sm:w-28">
                    {adminProfile.initials}
                    <span className="absolute inset-0 flex flex-col items-center justify-center bg-[#11395d]/70 opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100">
            ...
            <div className="flex-1 text-center sm:text-left">
                <h3 className="text-2xl font-bold text-[#11395d]">
