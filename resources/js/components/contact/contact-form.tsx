            ...
            <form className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <select
                            id="subject"
                            name="subject"
                            className={`${baseInputClassName} appearance-none pr-10`}
                            required
                            defaultValue=""
                        >
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        className="w-full resize-none rounded-[8px] border-none bg-[#F3F4F6] p-4 ring-2 ring-transparent transition outline-none focus:ring-[#35ADD5]/20"
                        required
                    />
                </div>
                ...
                <div className="pt-4">
                    <button
                        type="submit"
                        className="h-12 w-full rounded-[8px] text-[16px] font-medium text-white transition hover:opacity-90"
