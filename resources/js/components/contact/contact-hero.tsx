...
export function ContactHero() {
    return (
        <section className="relative flex h-[250px] w-full items-center justify-center overflow-hidden md:h-[350px]">
            <img
            ...
            <div className="relative z-10 px-6 text-center text-white">
                <h1 className="mb-4 text-4xl font-bold md:text-[52px]">Contact Us</h1>
                <nav className="flex items-center justify-center gap-3 text-sm md:text-lg" aria-label="Breadcrumb">
                    <Link href={home.url()} className="opacity-80 transition hover:text-[#35ADD5] hover:opacity-100 text-[20px]">
                        Home
                    </Link>
                    <svg
                        width="8"
