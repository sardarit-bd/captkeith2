    ...
    return (
        <article className="group flex flex-col justify-between gap-5 rounded-2xl border border-[#f1f5f9] bg-white p-5 shadow-sm transition-all duration-200 hover:shadow-md sm:flex-row sm:items-center sm:p-6">
            <div className="flex items-center gap-5">
                <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-xl border border-[#f1f5f9] shadow-sm transition-shadow group-hover:shadow-md sm:h-20 sm:w-20">
                    <img
            ...
            <div className="flex w-full flex-row items-center justify-between gap-6 border-t border-[#f8fafc] pt-4 sm:w-auto sm:justify-end sm:gap-8 sm:border-0 sm:pt-0">
                <div className="flex items-center gap-3">
                    <div className="h-10 w-10 shrink-0 overflow-hidden rounded-full border border-[#e5e7eb] bg-[#f9fafb] shadow-sm">
                        <img
                ...
                <span className="inline-flex shrink-0 items-center rounded-full border border-[#D1FAE5] bg-[#ECFDF5] px-4 py-1.5 text-xs font-bold tracking-wide text-[#059669]">
                    {booking.status}
                </span>
            </div>
        </article>
