...
function RoleOption({
    ...
    return (
        <label htmlFor={id} className="group relative cursor-pointer">
            ...
            <div className="rounded-xl border-2 border-gray-100 bg-white p-4 text-center transition-all peer-checked:border-[#3DB3DE] peer-checked:bg-[#F9FCFF] hover:border-gray-200">
                <div className="mb-2 flex justify-center text-gray-400 transition-colors group-hover:text-[#015291] peer-checked:text-[#3DB3DE]">
                    {icon}
                </div>
                <span className="block text-sm font-medium text-gray-600 peer-checked:text-[#35ADD5]">
                    {label}
                </span>
            </div>
...
const roleLabels: Record<RegistrableRole, { label: string; icon: ReactNode }> =
    {
        ...
        deckhand: {
            label: 'Deckhand',
            icon: <LifeBuoy className="h-7 w-7" strokeWidth={1.5} />,
        },
        charterer: {
            label: 'Charterer',
...
export default function Register({
    roles = ['owner', 'captain', 'deckhand', 'charterer'],
        ...
        return [
            {
                ...
                matched: passwordValue.length >= 12,
            },
            {
                ...
                <div className="relative hidden flex-col justify-between bg-[#35ADD5] p-10 md:flex md:w-5/12 lg:w-1/2 lg:p-14">
                    ...
                    <div className="relative z-20 my-auto max-w-lg pt-12">
                        ...
                        <p className="text-[18px] leading-relaxed text-[#F9FCFFCC]">
                            Join the most trusted platform connecting boat
                            owners, charterers, and licensed maritime
                            professionals for safe and legal yacht charters.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="m-auto w-full max-w-140 px-6 py-20 sm:px-10 lg:px-12">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-[15px] text-gray-500">
                                Join CaptMatch today to start your maritime
                                journey.
                            </p>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            <div>
                                <p className="mb-3 block text-sm font-semibold text-[#35ADD5]">
