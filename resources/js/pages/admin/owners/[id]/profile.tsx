...
import { ArrowLeft, Save, Loader2, Ship, Mail, Phone, MapPin, Calendar, User } from 'lucide-react';
...
export default function OwnerProfile({ user, ownerProfile }: OwnerProfilePageProps) {
    const [activeTab, setActiveTab] = useState<'personal' | 'account' | 'marina'>('personal');
    ...
    const handleSave = (e: React.FormEvent) => {
        ...
        put(route('admin.owners.update', user.id), {
            onSuccess: () => {
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        ...
                                        {activeTab === 'marina' && 'Marina Information'}
                                        {activeTab === 'account' && 'Account Settings'}
                                    </CardTitle>
                                    <CardDescription>
                                        {activeTab === 'personal' && "Update the owner's personal details"}
                                        {activeTab === 'marina' && "Update the owner's marina details"}
                                        ...
                                        <div className="grid gap-4 md:grid-cols-2">
                                            <div className="space-y-2 md:col-span-2">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setData('marina_name', e.target.value)}
                                                    className={errors.marina_name ? 'border-red-500' : ''}
                                                />
                                                {errors.marina_name && (
                                                    <p className="text-xs text-red-500">{errors.marina_name}</p>
                                                )}
                                            </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setData('marina_city', e.target.value)}
                                                    className={errors.marina_city ? 'border-red-500' : ''}
                                                />
                                                {errors.marina_city && (
                                                    <p className="text-xs text-red-500">{errors.marina_city}</p>
                                                )}
                                            </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setData('marina_state', e.target.value)}
                                                    className={errors.marina_state ? 'border-red-500' : ''}
                                                />
                                                {errors.marina_state && (
                                                    <p className="text-xs text-red-500">{errors.marina_state}</p>
                                                )}
                                            </div>
                                        </div>
                                    )}
